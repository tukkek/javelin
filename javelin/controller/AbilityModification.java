...
public class AbilityModification {
	 ...
	 * increments.
	 */
	public ArrayList<Integer> modifications = new ArrayList<Integer>();
	/**
	 * Will be the final score value of the given ability, to be assigned.
	 */
	public int newscore;
	/**
	 * Alternative to using {@link #modifications}. Has the total different in
	 * the ability modifier (for example: +2 or -4).
	 */
	...
	/**
	 * @param currentscore
	 *            Current ability score. If equal to zero, {@link #modify(int)}
	 *            will have no effect and {@link #newscore} will return this
	 *            exact value so that it can be assined without changing
	 *            anything.
	 */
