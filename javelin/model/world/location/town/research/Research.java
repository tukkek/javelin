...
import javelin.model.world.location.town.ResearchData;
...
public abstract class Research extends Option {
	private static final int MAXIMUMOPTIONS = 10;
	...
	protected static void humandraw(Town t) {
		...
		if (t.research.hand[1] == null && t.upgrades.size() < MAXIMUMOPTIONS) {
			t.research.hand[1] = pick(myupgrades, t, 1);
		}
		if (t.research.hand[2] == null && t.upgrades.size() < MAXIMUMOPTIONS) {
			t.research.hand[2] = pick(otherupgrades, t, 2);
		}
		if (t.research.hand[3] == null && t.items.size() < MAXIMUMOPTIONS) {
			t.research.hand[3] = pick(myitems, t, 1);
		}
		if (t.research.hand[4] == null && t.items.size() < MAXIMUMOPTIONS) {
			t.research.hand[4] = pick(otheritems, t, 2);
		}
		if (t.research.hand[5] == null && t.lairs.size() < MAXIMUMOPTIONS) {
	...
	/**
	 * @param t
	 *            Cleans all {@link Town#research} options and redraw.
	 */
	public static void clear(Town t) {
