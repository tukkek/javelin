...
public class TouchAttack extends Upgrade implements Cloneable,Serializable{
	 ...
	 *
	 * @param die Number of die to roll for damage.
	 * @param sides Type of die to roll for damage.
	 * @param savedcp Will roll against this save DC.
	 */
	...
	public String inform(Combatant c){
		return name+" ("+damage[0]+"d"+damage[1]+", reflex save "+savedc+" half)";
	}
