...
public abstract class Mandate implements Serializable,Comparable<Mandate>{
  ...
  static{
    MANDATES.put(DEFAULT,List.of(RequestRuby.class,RequestCaravan.class));
  ...
  public static Mandate generate(Diplomacy d){
    try{
      ...
      for(var t:d.town.traits) deck.addAll(MANDATES.get(t));
  ...
  public static String printsummary(){
    var actions=0;
    for(var v:MANDATES.values()) actions+=v.size();
