...
public class TempleDungeon extends Dungeon {
	...
	String difficulty = Difficulty.describe(temple.el - ChallengeCalculator.calculateel(Squad.active.members));
	Character prompt = Javelin
		.prompt("You're at the entrance of the " + temple.descriptionknown + " (difficulty: " + difficulty
