...
public class Fire extends Target{
	...
	protected void attack(Combatant combatant,Combatant targetCombatant,
		...
		Action
				.outcome(RangedAttack.SINGLETON.attack(state,combatant,targetCombatant,
						combatant.chooseattack(combatant.source.ranged,targetCombatant),0));
	}
	...
	Attack predictattack(CurrentAttack hint,List<AttackSequence> fallback){
		...
		if(a==null) a=fallback.get(0).get(0);
		return a;
	}
