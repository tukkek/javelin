...
import javelin.controller.content.action.world.meta.Abandon;
import javelin.controller.content.action.world.meta.Automate;
import javelin.controller.content.action.world.meta.ClearHighscore;
import javelin.controller.content.action.world.meta.ConfigureWorldKeys;
import javelin.controller.content.action.world.meta.OpenJournal;
import javelin.controller.content.action.world.meta.Rename;
import javelin.controller.content.action.world.meta.ShowOptions;
import javelin.controller.content.action.world.meta.ShowStatistics;
import javelin.controller.content.action.world.meta.help.Guide;
import javelin.controller.content.action.world.meta.help.WorldHelp;
import javelin.controller.content.action.world.meta.zoom.ZoomWorldIn;
import javelin.controller.content.action.world.meta.zoom.ZoomWorldOut;
...
public abstract class WorldAction implements ActionDescription{
  /** All world actions. */
  public static final WorldAction[] ACTIONS={ //
      new Automate(), // a
      new Camp(), // c
      new Divide(), // d
