...
public interface Node extends Cloneable{
	 ...
	 *         atual. Note que a t�cnica de poda alfabeta apresenta uma tend�ncia
	 *         a selecionar jogadas apresentadas primeiro, ent�o � recomend�vel
	 *         retornar poss�veis jogadas da maneira mais aleat�ria poss�vel, de
	 *         modo a evitar "maneirismos" por parte do jogador artificial.
	 * @author Alex Henry
	 */
