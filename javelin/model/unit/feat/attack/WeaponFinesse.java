 ...
 * Finesse can only be upgraded through
 * {@link Monster#changedexteritymodifier(int)}. Ideally, it should choose
 * between the best of either bonus.
 */
public class WeaponFinesse extends Feat{
	...
	public List<Attack> getallaffected(Monster m){
		ArrayList<Attack> affected=new ArrayList<>();
		for(AttackSequence attacks:m.melee)
			for(Attack a:attacks)
				if(affects(a)) affected.add(a);
		return affected;
	}
