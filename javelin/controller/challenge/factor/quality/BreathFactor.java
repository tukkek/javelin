...
public class BreathFactor extends CrFactor{
	...
	public void registerupgrades(UpgradeHandler handler){
		...
		handler.water.add(new BreathUpgrade(new BreathWeapon("caustic liquid",
				BreathArea.CONE,15,1,8,0,SavingThrow.REFLEXES,12,.5f,true)));

		handler.evil.add(new BreathUpgrade(new BreathWeapon("acid",BreathArea.LINE,
				80,12,4,0,SavingThrow.REFLEXES,23,.5f,true)));
		handler.wind.add(new BreathUpgrade(new BreathWeapon("lightning",
				BreathArea.LINE,100,12,8,0,SavingThrow.REFLEXES,25,.5f,true)));
		handler.fire.add(new BreathUpgrade(new BreathWeapon("fire",BreathArea.CONE,
				50,12,10,0,SavingThrow.REFLEXES,25,.5f,true)));
		handler.earth.add(new BreathUpgrade(new BreathWeapon("corrosive gas",
				BreathArea.CONE,50,12,6,0,SavingThrow.REFLEXES,25,.5f,true)));
		handler.wind.add(new BreathUpgrade(new BreathWeapon("cold",BreathArea.CONE,
