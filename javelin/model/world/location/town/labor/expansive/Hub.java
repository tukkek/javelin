...
public class Hub extends Location{
	...
	static final Option[] TRANSPORTATION=new Option[]{CARRIAGE,SHIP,AIRSHIP};
	static final String[] NAMES=new String[]{"Stables","Docks","Magic dock"};
	...
	class ShowTransport extends PurchaseScreen{
		...
		public List<Option> getoptions(){
			...
			list.add(REFUND);
			if(Squad.active.transport==null) for(int i=0;i<=stables.level;i++)
