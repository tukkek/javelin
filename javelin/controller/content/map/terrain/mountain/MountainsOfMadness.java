...
public class MountainsOfMadness extends Map{
  ...
  public void generate(){
    while(structures.size()<AREA*structureratio) buildstructure();
    while(maze.size()<(AREA-structures.size())*mazeratio) buildmaze();
    clearmaze();
  }
  ...
  public boolean validate(){
    return Weather.current==Weather.STORM||Season.current==Season.WINTER;
  }
}
