...
public class Calendar{
	...
	/**
	 * Months are never actually shown to the player but are still a useful period
	 * of time when designing game features.
	 */
	 ...
	 * doing algebra in their heads in order to understand what proper season/year
	 * it should be 10 days from now.
	 *
