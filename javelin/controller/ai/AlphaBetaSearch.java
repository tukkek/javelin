 ...
 * @see AiCache
 *
 * @param <K> Implementa��o de {@link Node} que define os poss�veis estados de
 *          jogo.
 */
public abstract class AlphaBetaSearch{
	 ...
	 * esgotado e nenhuma busca tenha sido completada, ele � ignorado e se retorna
	 * a primeira busca completa, quando ela estiver terminada.
	 *
	 * @param node Um {@link Node estado de jogo}, para o qual uma jogada precisa
	 *          ser escolhida.
	...
	public List<ChanceNode> alphaBetaSearch(final Node node){
		try{
			...
			List<ChanceNode> result=selector.getValue(
					new Entry(node,selector.failure,new ArrayList<ChanceNode>()),this,0,
					-Float.MAX_VALUE,Float.MAX_VALUE,new ArrayList<Integer>(10)).cns;
			if(result.isEmpty()) System.out.println("#emptynodelist");
			return result;
	 ...
	 * <br/>
	 * Exemplo: "A pillha estourou. Voc� precisa executar o programa ajustando os
	 * argumentos -Xmx e -Oss da JVM. Vide detalhes na sa�da padr�o."
	 *
	 * @param e O erro a ser avisado.
	...
	/**
	 * Essa fun��o mede o valor de utilidade de um determinado estado quando este
	 * estado � terminal, e funciona como a fun��o <b>eval</b> para estados n�o
	 * terminais.
	 *
	 * @param node O estado a ser avaliado.
	 *
	 * @return Uma representa��o num�rica do valor de jogo para este estado. Esta
	 *         pode ser negativa ou positiva, representando uma situa��o favor�vel
	 *         a um dos respectivos jogadores. Os valores mais extremos em ambos
	 *         os casos ser�o aqueles almejados pela IA, e geralmente devem ser os
	 *         valores que indicam fim do jogo.
	 */
	 ...
	 *
	 * @param node Estado a ser verificado.
