...
public class BattlePanel extends MapPanel {
	...
	daylight = period.equals(Javelin.PERIODMORNING) || period.equals(Javelin.PERIODNOON);
    }
	...
	try {
	    updatestate();
	    super.refresh();
	    final HashSet<Point> update = new HashSet<>(Fight.state.redTeam.size() + Fight.state.blueTeam.size());
	...
	daylight = state.period.equals(Javelin.PERIODMORNING) || state.period.equals(Javelin.PERIODNOON);
