...
public abstract class Wish extends Option{
  ...
  public static class WishScreen extends SelectScreen{
    ...
    void pay(double nrubies){
      for(var i=0;i<nrubies;i++) Squad.active.equipment.pop(Ruby.class);
    }

    Combatant selectmember(){
      Combatant target;
      var members=new ArrayList<String>();
      for(Combatant c:Squad.active.members) members.add(c.toString());
    ...
    public List<Option> getoptions(){
      var wishes=new ArrayList<Option>();
