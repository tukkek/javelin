...
public class PrintfFormat {
     ...
     * a string. Primitive types must be passed using wrapper types. The
     ...
     * <code>n</code>$, where <code>n</code> is a decimal integer giving
     ...
     * <td>\b</td>
     * <td>backspace</td>
     * <td>Moves the printing position to one column before the current
     * position, unless the current position is the start of a line.</td>
     * </tr>
     * <tr>
     * <td>\f</td>
     * <td>form-feed</td>
     * <td>Moves the printing position to the initial printing position of the
     * next logical page.</td>
     * </tr>
     * <tr>
     * <td>\n</td>
     * <td>newline</td>
     ...
     * the form of a decimal integer. If the conversion character is s, the
     * field width is the the minimum number of characters to be printed.
     * </p>
     * <p>
     * An optional precision that gives the minumum number of digits to appear
     * for the d, i, o, x or X conversions (the field is padded with leading
     * zeros); the number of digits to appear after the radix character for the
     * e, E, and f conversions, the maximum number of significant digits for the
     * g and G conversions; or the maximum number of characters to be written
     * from a string is s and S conversions. The precision takes the form of an
     * optional decimal digit string, where a null digit string is treated as 0.
     * If a precision appears with a c conversion character the precision is
     * ignored.
     * </p>
     * <p>
     ...
     * according to the integral promotions and its value converted to type
     * short before printing).
     * </p>
     * <p>
     * An optional l (ell) specifies that a following d, i, o, x, or X
     ...
     * a digit string. In this case, an integer argument supplised the field
     * width precision. The argument that is actually converted is not fetched
     * until the conversion letter is seen, so the the arguments specifying
     * field width or precision must appear before the argument (if any) to be
     * converted. If the precision argument is negative, it will be changed to
     * zero. A negative field width argument is taken as a - flag, followed by a
     * positive field width.
     * </p>
     * <p>
     * In format strings containing the %<code>n</code>$ form of a
     * conversion specification, a field width or precision may be indicated by
     * the sequence *<code>m</code>$, where m is a decimal integer giving
     * the position in the argument list (after the format argument) of an
     * integer argument containing the field width or precision.
     * </p>
     * <p>
     * The format can contain either numbered argument specifications (that is, %
     * <code>n</code>$ and *<code>m</code> $), or unnumbered argument
     * specifications (that is % and *), but normally not both. The only
     * exception to this is that %% can be mixed with the %<code>n</code>$
     ...
     * <dl>
     * <dt>'
     * <dd>integer portion of the result of a decimal conversion (%i, %d, %f,
     ...
     * character is used.
     * <dt>-
     * <dd>result of the conversion is left-justified within the field. (It
     * will be right-justified if this flag is not specified).</td>
     * </tr>
     * <dt>+
     * <dd>result of a signed conversion always begins with a sign (+ or -).
     ...
     * <dt>0
     * <dd>d, i, o, x, X, e, E, f, g, and G conversions, leading zeros
     * (following any indication of sign or base) are used to pad to the field
     * width; no space padding is performed. If the 0 and - flags both appear,
     * the 0 flag is ignored. For d, i, o, x, and X conversions, if a precision
     * is specified, the 0 flag will be ignored. For c conversions, the flag is
     * ignored.
     * </dl>
     * 
     ...
     * Usually, an unchecked exception will be thrown. If the format is
     ...
     * <dl>
     * <dt>d,i
     * <dd>The int argument is converted to a signed decimal in the style
     * [-]dddd. The precision specifies the minimum number of digits to appear;
     * if the value being converted can be represented in fewer digits, it will
     * be expanded with leading zeros. The default precision is 1. The result of
     ...
     * ddddd. The precision specifies the minimum number of digits to appear; if
     ...
     * default precision is 1. The result of converting 0 with an explicit
     ...
     * <dt>f
     * <dd>The floating point number argument is written in decimal notation in
     ...
     * specification. A Locale is used to determine the radix character to use
     * in this format. If the precision is omitted from the argument, six digits
     * are written after the radix character; if the precision is explicitly 0
     * and the # flag is not specified, no radix character appears. If a radix
     ...
     * precision. A Locale is used to determine the radix character to use in
     * this format. When the precision is missing, six digits are written after
     * the radix character; if the precision is 0 and the # flag is not
     * specified, no radix character appears. The E conversion will produce a
     * number with E instead of e introducing the exponent. The exponent always
     * contains at least two digits. However, if the value to be written
     * requires an exponent greater than two digits, additional exponent digits
     * are written as necessary. The value is rounded to the appropriate number
     * of digits.
     * <dt>g,G
     ...
     * specifying the number of significant digits. If the precision is zero, it
     * is taken as one. The style used depends on the value converted: style e
     * (or E) will be used only if the exponent resulting from the conversion is
     * less than -4 or greater than or equal to the precision. Trailing zeros
     * are removed from the result. A radix character appears only if it is
     * followed by a digit.
     * <dt>c,C
     * <dd>The integer argument is converted to a char and the result is
     * written.
     * 
     * <dt>s,S
     ...
     * the precision specification of the argument is reached. If the precision
     * is omitted from the argument, it is taken to be infinite, so all
     * characters up to the end of the string are written.
     * <dt>%
     * <dd>Write a % character; no argument is converted.
     * </dl>
     * <p>
     * If a conversion specification does not match one of the above forms, an
     * IllegalArgumentException is thrown and the instance of PrintfFormat is
     * not created.
     * </p>
     * <p>
     ...
     * "not-a-number," the output is [+]NaN. Printing of the sign follows the
     ...
     * is used before the e, E, g, or G conversion character. The optional L
     * does not imply conversion to a long long double.
     * </p>
     * <p>
     * The biggest divergence from the C printf specification is in the use of
     * 16 bit characters. This allows the handling of characters beyond the
     * small ASCII character set and allows the utility to interoperate
     * correctly with the rest of the Java runtime environment.
     * </p>
     * <p>
     * Omissions from the C printf specification are numerous. All the known
     * omissions are present because Java never uses bytes to represent
     ...
     * <li>c, C, d,i,o,u,x, and X conversion characters apply to Byte,
     * Character, Short, Integer, Long types.
     * <li>f, e, E, g, and G conversion characters apply to Float and Double
     * types.
     * <li>s and S conversion characters apply to String types.
     * <li>All other reference types can be formatted using the s or S
     * conversion characters only.
     * </ul>
     * <p>
     * Most of this specification is quoted from the Unix man page for the
     * sprintf utility.
     * </p>
     * 
     * @author Allan Jacobs
     * @version 1 Release 1: Initial release. Release 2: Asterisk field widths
     *          and precisions %n$ and *m$ Bug fixes g format fix (2 digits in e
     *          form corrupt) rounding in f format implemented round up when
     *          digit not printed is 5 formatting of -0.0f round up/down when
     *          last digits are 50000...
     */
    ...
    public static void main(String[] args) {
        System.out.println(new PrintfFormat("%10s | %20s | ").sprintf(new Object[]{"blue", "moon"}));
    }
    ...
    public String sprintf(Object[] o) {
        ...
        while (e.hasMoreElements()) {
            ...
            if (c == '\0') sb.append(cs.getLiteral());
                ...
                else if (o[i] instanceof Short) sb.append(cs.internalsprintf(((Short) o[i]).shortValue()));
                else if (o[i] instanceof Integer) sb.append(cs.internalsprintf(((Integer) o[i]).intValue()));
                else if (o[i] instanceof Long) sb.append(cs.internalsprintf(((Long) o[i]).longValue()));
                else if (o[i] instanceof Float) sb.append(cs.internalsprintf(((Float) o[i]).floatValue()));
                else if (o[i] instanceof Double) sb.append(cs.internalsprintf(((Double) o[i]).doubleValue()));
                else if (o[i] instanceof Character) sb.append(cs.internalsprintf(((Character) o[i]).charValue()));
                else if (o[i] instanceof String) sb.append(cs.internalsprintf((String) o[i]));
                else
    ...
    public String sprintf(Object x) throws IllegalArgumentException {
        ...
        while (e.hasMoreElements()) {
            ...
            if (c == '\0') sb.append(cs.getLiteral());
                ...
                else if (x instanceof Short) sb.append(cs.internalsprintf(((Short) x).shortValue()));
                else if (x instanceof Integer) sb.append(cs.internalsprintf(((Integer) x).intValue()));
                else if (x instanceof Long) sb.append(cs.internalsprintf(((Long) x).longValue()));
                else if (x instanceof Float) sb.append(cs.internalsprintf(((Float) x).floatValue()));
                else if (x instanceof Double) sb.append(cs.internalsprintf(((Double) x).doubleValue()));
                else if (x instanceof Character) sb.append(cs.internalsprintf(((Character) x).charValue()));
                else if (x instanceof String) sb.append(cs.internalsprintf((String) x));
                else
                    sb.append(cs.internalsprintf(x));
            }
        }
    ...
    private class ConversionSpecification {
            ...
            if (fmtArg.charAt(0) == '%') {
                ...
                if (setConversionCharacter()) {
                    if (pos == fmtArg.length()) {
                        if (leadingZeros && leftJustify) leadingZeros = false;
        ...
        String internalsprintf(int s) throws IllegalArgumentException {
            ...
            case 'd':
            case 'i':
                if (optionalh) s2 = printDFormat((short) s);
                else if (optionall) s2 = printDFormat((long) s);
                else
                    s2 = printDFormat(s);
                break;
            case 'x':
            case 'X':
                if (optionalh) s2 = printXFormat((short) s);
                else if (optionall) s2 = printXFormat((long) s);
                else
                    s2 = printXFormat(s);
                break;
            case 'o':
                if (optionalh) s2 = printOFormat((short) s);
                else if (optionall) s2 = printOFormat((long) s);
                else
                    s2 = printOFormat(s);
                break;
            case 'c':
        ...
        String internalsprintf(long s) throws IllegalArgumentException {
            ...
            case 'i':
                if (optionalh) s2 = printDFormat((short) s);
                else if (optionall) s2 = printDFormat(s);
                else
            ...
            case 'X':
                if (optionalh) s2 = printXFormat((short) s);
                else if (optionall) s2 = printXFormat(s);
                else
                    s2 = printXFormat((int) s);
                break;
            case 'o':
                if (optionalh) s2 = printOFormat((short) s);
                else if (optionall) s2 = printOFormat(s);
                else
        ...
        String internalsprintf(String s) throws IllegalArgumentException {
            String s2 = "";
            if (conversionCharacter == 's' || conversionCharacter == 'S') s2 = printSFormat(s);
            else
        ...
        String internalsprintf(Object s) {
            String s2 = "";
            if (conversionCharacter == 's' || conversionCharacter == 'S') s2 = printSFormat(s.toString());
            else
                throw new IllegalArgumentException("Cannot format a String with a format using" + " a " + conversionCharacter
                        + " conversion character.");
            return s2;
        ...
        private char[] fFormatDigits(double x) {
            ...
            if (n1In + expon <= 0) {
                ...
                if (!carry) {
                    if (alternateForm || !precisionSet || precision != 0) ca4 = new char[n1In + expon + p + 1];
                    else
                        ca4 = new char[n1In + expon];
                    j = 0;
                } else {
                    if (alternateForm || !precisionSet || precision != 0) ca4 = new char[n1In + expon + p + 2];
                    else
            ...
            if (!leftJustify && leadingZeros) {
                ...
                if (fieldWidthSet) nZeros = fieldWidth - ca4.length;
                if ((!minusSign && (leadingSign || leadingSpace)) || minusSign) nZeros--;
                nZeros -= xThousands;
            ...
            if (dp < ca5.length) ca5[dp] = dfs.getDecimalSeparator();
            char[] ca6 = ca5;
        ...
        private String fFormatString(double x) {
            ...
            if (Double.isInfinite(x)) {
                if (x == Double.POSITIVE_INFINITY) {
                    ...
                    else if (leadingSpace) ca6 = " Inf".toCharArray();
                    else
                        ca6 = "Inf".toCharArray();
                } else
                    ca6 = "-Inf".toCharArray();
                ...
                else if (leadingSpace) ca6 = " NaN".toCharArray();
                else
                    ca6 = "NaN".toCharArray();
            } else
                ca6 = fFormatDigits(x);
        ...
        private char[] eFormatDigits(double x, char eChar) {
            ...
            else if (rPos != -1) ca1 = (sx.substring(0, rPos) + sx.substring(rPos + 1)).toCharArray();
            else if (ePos != -1) ca1 = sx.substring(0, ePos).toCharArray();
            else
                ca1 = sx.toCharArray();
            boolean carry = false;
            int i0 = 0;
            ...
            if (Math.abs(expon) < 100 && !optionalL) eSize = 4;
                ...
                eSize = 5;
            if (alternateForm || !precisionSet || precision != 0) ca2 = new char[2 + p + eSize];
            else
            ...
            if (!leftJustify && leadingZeros) {
                ...
                if (fieldWidthSet) nZeros = fieldWidth - ca2.length;
                if ((!minusSign && (leadingSign || leadingSpace)) || minusSign) nZeros--;
                nZeros -= xThousands;
                if (nZeros < 0) nZeros = 0;
            }
            ...
            int nThousands = dp / 3;
            // Localize the decimal point.
            if (dp < ca3.length) ca3[dp] = dfs.getDecimalSeparator();
            char[] ca4 = ca3;
            if (thousands && nThousands > 0) {
        ...
        private String printEFormat(double x) {
            if (conversionCharacter == 'e') return eFormatString(x, 'e');
        ...
        private String printDFormat(String sx) {
            ...
            if (!neg) {
                if (precisionSet && sx.length() < precision) nLeadingZeros = precision - sx.length();
            } else {
                if (precisionSet && (sx.length() - 1) < precision) nLeadingZeros = precision - sx.length() + 1;
            }
            if (nLeadingZeros < 0) nLeadingZeros = 0;
            if (fieldWidthSet) {
                nBlanks = fieldWidth - nLeadingZeros - sx.length();
                if (!neg && (leadingSign || leadingSpace)) nBlanks--;
            }
        ...
        private String printXFormat(String sx) {
            ...
            if (leftJustify) {
                ...
                if (!leadingZeros) for (int j = 0; j < nBlanks; j++, i++)
                    ca[i] = ' ';
                if (alternateForm) {
                    ca[i++] = '0';
                    ca[i++] = 'x';
            ...
            if (conversionCharacter == 'X') caReturn = caReturn.toUpperCase();
            return caReturn;
        }
        ...
        private String printOFormat(String sx) {
            ...
            if (nLeadingZeros < 0) nLeadingZeros = 0;
            if (fieldWidthSet) nBlanks = fieldWidth - nLeadingZeros - sx.length();
            if (nBlanks < 0) nBlanks = 0;
            ...
            if (leftJustify) {
                ...
                if (leadingZeros) for (i = 0; i < nBlanks; i++)
                    ca[i] = '0';
                else
                    for (i = 0; i < nBlanks; i++)
                        ca[i] = ' ';
        ...
        private String printSFormat(String x) {
            int nPrint = x.length();
            int width = fieldWidth;
            if (precisionSet && nPrint > precision) nPrint = precision;
            if (!fieldWidthSet) width = nPrint;
            int n = 0;
        ...
        private void setArgPosition() {
            ...
            for (xPos = pos; xPos < fmt.length(); xPos++) {
                if (!Character.isDigit(fmt.charAt(xPos))) break;
            }
