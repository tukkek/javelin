...
public class AvatarHandler {
	...
	TreeMap<String, LinkedList<LinkedList<String>>> pool = new TreeMap<String, LinkedList<LinkedList<String>>>();
	private final TreeMap<String, String> registered = new TreeMap<String, String>();
	static TreeMap<String, String> typetranslation = new TreeMap<String, String>();
	static {
