...
public abstract class Trap extends Feature{
  ...
  public boolean activate(){
    ...
    var disabler=Squad.active.getbest(Skill.DISABLEDEVICE);
    var disable=disabler.taketen(Skill.DISABLEDEVICE);
    if(disable>=disarmdc){
  ...
  public boolean discover(Combatant searching,int searchroll){
    ...
    for(var c:Squad.active.members){
      var p=c.taketen(Skill.PERCEPTION);
  ...
  public boolean reveal(boolean found){
    ...
    Decoration.onreveal=this::spring;
    return true;
  }
}
