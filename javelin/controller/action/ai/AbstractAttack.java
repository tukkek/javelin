...
public abstract class AbstractAttack extends AiAction {
	...
	List<DamageChance> dealattack(final BattleState gameState,
		...
		final float confirmchance =
				target.source.immunitytocritical ? 0 : threatchance * hitchance;
	...
	public float misschance(final BattleState gameState,
		...
		return AbstractAttack.bind((target.ac()
				+ getpenalty(current, target, gameState) - attackbonus) / 20f);
	}
